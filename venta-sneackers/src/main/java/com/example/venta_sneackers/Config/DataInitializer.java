...
public class DataInitializer implements CommandLineRunner {
    ...
    private void seedPedidos() {
        ...
        */
        ...
        pedidoRepository.save(new Pedido(null, "2024-02-20", new BigDecimal("150.00"), new BigDecimal("10.00"), new BigDecimal("140.00"), true, cliente2));
        pedidoRepository.save(new Pedido(null, "2024-03-10", new BigDecimal("120.00"), new BigDecimal("0.00"), new BigDecimal("120.00"), false, cliente3));
